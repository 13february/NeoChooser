...
**Neo Image Chooser** — это узел для выбора изображений, выполненный в приятном UI. Он позволяет останавливать рабочий процесс для выбора лучших кадров либо для подверждения сохранения изображения.
